        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-5">
                ...
                {items.map((item) => (
                  ...
                  >
                    ...
                    <div className="text-center">
                      <span
                        className={`text-xs font-semibold px-2.5 py-1 rounded-md ${categoryColors[item.category] || "bg-gray-100 text-gray-600"}`}
                      >
                        {item.category}
                      </span>
                    </div>
          ...
          <div className="xl:col-span-1 flex flex-col gap-4">
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(160deg, #1d4ed8 0%, #1e40af 60%, #1e3a8a 100%)",
              }}
            >
