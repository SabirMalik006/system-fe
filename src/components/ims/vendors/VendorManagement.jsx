...
const VendorManagement = () => {
  ...
  const handleUpdateVendor = async () => {
    try {
      ...
      const res = await vendorsAPI.updateVendor(
        vendorToEdit._id || vendorToEdit.id,
        payload,
      );
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          ...
          >
            ...
            <div className="p-4 sm:p-5 space-y-6">
              {/* NAME */}
              <div>
                <h3 className="uppercase text-[9px] sm:text-[10px] font-semibold tracking-wider text-blue-200 mb-3">
                  NAME
                </h3>
                <div>
                  <label className="text-[11px] sm:text-xs text-blue-200 mb-1 block">
              ...
              <div>
                ...
                <div>
                  <div className="flex border border-gray-300 rounded-sm overflow-hidden bg-white">
                    ...
                    />
                    <button
                      className="bg-gray-100 px-3 text-gray-600 text-xs border-l border-gray-300 hover:bg-gray-200"
                      title="Generate ID"
                      onClick={() =>
                        setFormData((prev) => ({
                          ...prev,
              ...
              <div>
                ...
                <div className="space-y-2">
                  <div className="text-[11px] sm:text-xs text-blue-200 mb-1.5">
                    Select Rating (0 - 5)
                  </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  <label className="flex items-center gap-3 px-3 py-2.5 rounded-lg cursor-pointer hover:bg-white/15">
                    ...
                    <span className="ml-auto bg-emerald-500 text-white text-[9px] sm:text-[10px] px-2 py-0.5 rounded-full">
                      Recommended
                    </span>
                  </label>
                  ...
                  <label className="flex items-center gap-3 px-3 py-2.5 rounded-lg cursor-pointer hover:bg-white/10">
                    ...
                    <span className="ml-auto bg-red-500 text-white text-[9px] sm:text-[10px] px-2 py-0.5 rounded-full">
                      Restricted
                    </span>
                  </label>
                </div>
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          ...
          >
            <div className="bg-white flex items-center justify-between px-4 py-2.5 border-b">
              ...
              <button
                onClick={() => setShowDeleteVendor(false)}
            ...
            <div className="bg-gray-50 flex gap-2 px-4 py-2.5 border-t">
              <button
                onClick={() => setShowDeleteVendor(false)}
                className="flex-1 py-1.5 border border-gray-300 rounded-sm text-gray-700 font-medium hover:bg-gray-100 transition-colors text-xs cursor-pointer"
              >
                Cancel
              </button>
              <button
                onClick={handleDeleteVendor}
                className="flex-1 py-1.5 bg-red-600 text-white rounded-sm font-medium hover:bg-red-700 transition-colors text-xs cursor-pointer"
              >
                Delete Vendor
              </button>
            </div>
